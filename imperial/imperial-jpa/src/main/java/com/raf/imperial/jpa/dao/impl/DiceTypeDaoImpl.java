...
import com.raf.imperial.jpa.dao.DiceTypeDao;
 ...
 */
@Repository
public final class DiceTypeDaoImpl extends AbstractDao<DiceType, String> implements DiceTypeDao {
   ...
   */
  @Override
  protected Predicate[] getPredicates(final Root<DiceType> root, final DiceType example) {
   ...
   */
  @Override
  protected List<Order> getOrder(final CriteriaBuilder builder, final Root<DiceType> root) {
