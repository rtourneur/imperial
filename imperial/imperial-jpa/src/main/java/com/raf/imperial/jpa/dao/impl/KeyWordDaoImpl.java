...
import com.raf.imperial.jpa.dao.KeyWordDao;
import com.raf.imperial.jpa.domain.model.KeyWord;

/**
 * Implementation DAO for {@link KeyWord}.
 *
 * @author RAF
 */
@Repository
public final class KeyWordDaoImpl extends AbstractDao<KeyWord, String> implements KeyWordDao {
   ...
   */
  @Override
  protected Predicate[] getPredicates(final Root<KeyWord> root, final KeyWord example) {
   ...
   */
  @Override
  protected List<Order> getOrder(final CriteriaBuilder builder, final Root<KeyWord> root) {
