...
import com.raf.imperial.jpa.dao.TraitDao;
 ...
 */
@Repository
public final class TraitDaoImpl extends AbstractDao<Trait, String> implements TraitDao {
   ...
   */
  @Override
  protected Predicate[] getPredicates(final Root<Trait> root, final Trait example) {
   ...
   */
  @Override
  protected List<Order> getOrder(final CriteriaBuilder builder, final Root<Trait> root) {
